#!/bin/bash
#SBATCH --job-name=TurbOPark-resume
#SBATCH --output=./logs/turbopark_resume_%A.log
#SBATCH --error=./logs/turbopark_resume_%A.err
...
#============================================================================
# TurbOPark Dataset Generation - Resume Script
#============================================================================
# Usage: sbatch submit_turbopark_resume.sh
#
# Use this script to resume an interrupted generation run.
# It skips already completed layouts.
#
...
echo "============================================================"
echo "TurbOPark Dataset Generation - RESUME MODE"
echo "============================================================"
echo "Date: $(date)"
echo "Node: ${NODE_ID}"
...
echo ""
echo "=== Resuming Dataset Generation ==="
echo "Flags: --resume"
python main.py --config ${DATASET_CONFIG} --resume
